...
/**
 * @brief Compare the firn 'n' chars of null-terminated strings.
 * @param str1 The first string.
 * @param str2 The second string.
 * @return 0 if equal, a negative number if str1 is less than str2, a positive number if str1 is greater than str2.
 */
int strncmp(const char *str1, const char *str2, unsigned int n);

char * without_final_spaces(char * str);
